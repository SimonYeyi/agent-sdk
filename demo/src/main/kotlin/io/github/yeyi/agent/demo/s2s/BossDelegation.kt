...
class BossDelegation(private val boss: BossAgent) : RealtimeDelegation {
    override val classifier: IntentionClassifier by lazy { LlmIntentionClassifier(capabilities) }
...
private class LlmIntentionClassifier(private val capabilities: List<String>) : IntentionClassifier {
    private var q = ""
    private var a = ""
